...
export const PresentationItems = [
    ...
    { id: 'e1-2', source: '1', target: '2', sourceHandle:'b', targetHandle:'t', animated: true },
    { id: 'e1-3', source: '1', target: '3', sourceHandle:'l', targetHandle:'r', animated: true },
    { id: 'e1-4', source: '1', target: '4', sourceHandle:'r', targetHandle:'l', animated: true },
];